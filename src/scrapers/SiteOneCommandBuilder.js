...
export class SiteOneCommandBuilder {
  static async build(url, outputDir, mergedConfig, extractDir = null) {
    ...
    const args = [
      ...
      "--replace-content='//min-width -> min-width'",
      "--replace-content='/ / min-width -> min-width'",
      "--replace-content='// margin -> margin'",
      "--replace-content='//  margin -> margin'",
      "--replace-content='//font-size -> font-size'",
      "--replace-content='//line-height -> line-height'",
      "--replace-content='/\\/\\/height/ -> height'",
      "--replace-content='/\\/\\/width/ -> width'",
      "--replace-content='*border -> border'",
      "--replace-content='*zoom -> zoom'",
      "--replace-content='// font-style -> font-style'",
      "--replace-content='// position -> position'",
      "--replace-content='// height -> height'",
      "--replace-content='// border -> border'",
      "--replace-content='//  width -> width'",
      "--replace-content='// width -> width'",
      "--replace-content='/ / width -> width'",
      "--replace-content='//padding-left -> padding-left'",
      "--replace-content='/ / padding-left -> padding-left'",
      "--replace-content='/ / min-height -> min-height'",
      "--replace-content='/ / max-width -> max-width'",
      "--replace-content='/ / max-height -> max-height'",
      "--replace-content='// max-height -> max-height'",
      "--replace-content='// background-color -> background-color'",
      "--replace-content='// display -> display'",
      "--replace-content='//padding-right -> padding-right'",
      "--replace-content='/\\/\\/top/ -> top'",
      "--replace-content='//margin-top -> margin-top'",
      "--replace-content='/\\/\\/left/ -> left'",
      "--replace-content='// padding -> padding'",
      "--replace-content='// z-index -> z-index'",
      "--replace-content='// font-family -> font-family'",
      "--replace-content='//  font-weight -> font-weight'",
      "--replace-content='//  height -> height'",
